...
exports.createMessageRecipientsTableQ = exports.createMessagesTableQ = exports.createChatMembersTableQ = exports.createChatsTableQ = exports.createWorkspaceMembersTableQ = exports.createWorkspacesTableQ = exports.createUsersTableQ = void 0;
const createUsersTableQ = () => {
    return `
        CREATE TABLE IF NOT EXISTS users (
            ...
            -- NOTE: as the mysql cloud server doesn't support this (uncomment in local env)
...
exports.createUsersTableQ = createUsersTableQ;
const createWorkspacesTableQ = () => {
    return `
...
exports.createWorkspacesTableQ = createWorkspacesTableQ;
const createWorkspaceMembersTableQ = () => {
    return `
...
exports.createWorkspaceMembersTableQ = createWorkspaceMembersTableQ;
const createChatsTableQ = () => {
    return `
...
exports.createChatsTableQ = createChatsTableQ;
const createChatMembersTableQ = () => {
    return `
...
exports.createChatMembersTableQ = createChatMembersTableQ;
const createMessagesTableQ = () => {
    return `
...
exports.createMessagesTableQ = createMessagesTableQ;
const createMessageRecipientsTableQ = () => {
    return `
...
exports.createMessageRecipientsTableQ = createMessageRecipientsTableQ;
